...
Publish the approved tickets. **How** depends on the tracker in the config — the tickets are the same either way, only the shape of the blocking edges changes:
